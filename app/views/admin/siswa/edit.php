        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-4 py-4">
                    <form action="?controller=siswa&method=update" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tempat_lhr"
                                class="form-control border focus-ring focus-ring-success rounded-3"
                                value="<?= $siswa['tempat_lhr'] ?>" required>
                        </div>
                        <!-- Tgl Lahir -->
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label class="form-label">Kelas Saat Ini (Tahun Aktif)</label>
                            <select name="id_kelas" class="form-control border focus-ring focus-ring-success rounded-3 select2">
                                <option value="">-- Belum Masuk Kelas --</option>
                                <?php foreach ($kelas as $k): ?>
                                    <option value="<?= $k['id_kelas'] ?>"
                                        <?= ($siswa['current_id_kelas'] == $k['id_kelas']) ? 'selected' : '' ?>>
                                        <?= $k['kelas'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            <small class="text-muted">*Mengubah kelas disini akan mengupdate data ploting tahun ini.</small>
                        </div>
