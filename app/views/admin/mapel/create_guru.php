        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-4 py-4">
                    <form action="?controller=mapel&method=store_guru" method="POST">
                        <input type="hidden" name="id_mapel" value="<?= $mapel['id_mapel'] ?>">
                        <input type="hidden" name="id_tahun_pelajaran" value="<?= $tahun_aktif['id_tahun_pelajaran'] ?>">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="id_guru"
                                ...
                                <?php foreach ($users as $u): ?>
                                    <option value="<?= $u['id_employe'] ?>"><?= $u['nama'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
