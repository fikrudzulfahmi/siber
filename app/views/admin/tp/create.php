            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Tambah Tujuan Pembelajaran</h6>
                ...
                <div class="card-body px-4 py-4">
                    <form action="?controller=tp&method=store" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tp"
                                ...
                                placeholder="Masukkan tujuan Pembelajaran" required>
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="?controller=tp&method=tujuan&id_mapel_guru=<?= $info['id_mapel_guru'] ?>" class="btn btn-outline-secondary me-2">Kembali</a>
