        ...
        <ul class="navbar-nav accordion" id="accordionSidebar">
            ...
            <?php if (isAnyLevel($id_level, [1, 5, 6, 7])): ?>
                ...
                ' . (
                    ...
                    ' . (
                        // Ploting Kelas: Admin (1), Kesiswaan (6), Level 7
                        (isAnyLevel($id_level, [1, 6, 7]) ?
                            '<li class="sidebar-item"><a class="nav-link text-white ' . (isActive("ploting", "index") ? "active bg-gradient-success" : "") . '" href="?controller=ploting&method=index"><i class="material-icons me-2 opacity-10">groups</i> Ploting Kelas</a></li>'
                            : '')
                    ) . '
                    ' . (
                        // Anggota Kelas: Admin (1), Kesiswaan (6), Level 7
                        (isAnyLevel($id_level, [1, 6, 7]) ?
                            '<li class="sidebar-item"><a class="nav-link text-white ' . (isActive("ploting", "anggota") ? "active bg-gradient-success" : "") . '" href="?controller=ploting&method=anggota"><i class="material-icons me-2 opacity-10">people</i> Anggota Kelas</a></li>'
                            : '')
                    ) . '
